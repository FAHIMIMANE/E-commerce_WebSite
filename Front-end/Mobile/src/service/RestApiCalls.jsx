...
export const getAllProductsDetailApi = async (pageNumber) => {
  ...
  console.log(`${BACKEND_API_GATEWAY_URL}/api/catalog/products?page=${pageNumber}&size=8`);
  return responseData;
};

export const addToCartApi = async (addToCartRequestBody, token) => {
...
export const getCartDetailsApi = async (token) => {
  const axiosConfig = {
    headers: {
      'Content-Type': 'application/json',
      'Authorization': 'Bearer ' + token
